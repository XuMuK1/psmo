По аварийным причинам репозиторий в процессе переезда. Ищите новый в аккаунте @XuMuK1-true.

Чтобы найти актуальное содержание курса, выберите нужную ветку: [год 2023](https://github.com/XuMuK1/psmo/tree/2023), [год 2024](https://github.com/XuMuK1/psmo/tree/2024).

А также спин-офф по задаче фильтрации и фильтру Калмана [год 2025](https://github.com/XuMuK1/psmo/tree/2025), который называют КалманСтат или Калманион.
